...
async function start() {
  console.log('\n╔══════════════════════════════════════╗');
  console.log('║    MAVERICK INTEL BOT v5.4           ║');
  console.log('║    SAS ENGINE + YAHOO DATA + WEBHOOK ║');
  console.log('╚══════════════════════════════════════╝\n');
  ...
  await tg(
    '<b>MAVERICK INTEL BOT v5.4 — ONLINE</b>\n\n' +
    '⚡ Mode: WEBHOOK — zero conflict\n' +
    ...
    '<b>🐋 v5.4 — SAS ENGINE LIVE:</b>\n' +
    '• /sas TICKER — Stealth Accumulation Score\n' +
    '• 5 components: volume anomaly, close position,\n' +
    '  multi-day buildup, ATR compression, acceleration\n' +
    '• Triple Confirmation: SAS + MIS + SDI all elevated\n' +
    '• SAS embedded in /science + /check outputs\n' +
    '• "stealth MDAI" natural language works\n\n' +
  ...
  console.log('[BOT] v5.4 running. SAS engine live. Yahoo data. 60s cache. Webhook. No polling.');
}
