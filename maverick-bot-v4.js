...
async function cmdStart(chatId) {
  await tg(
    ...
    '<b>🏆 TOP PICK</b>\n' +
    '/top-pick — highest-conviction setup right now, full case auto-runs\n\n' +
    ...
    '/confidence TICKER — 🧠 Trade Confidence Pulse (in-trade psychology)\n\n' +

    '<b>📡 SCANNERS</b>\n' +
    '/scan — full universe scored + ranked\n' +
    '/staircase (or /sc) — 🪜 active staircase scan\n' +
    '/squeeze — SDI-powered short squeeze candidates\n' +
    '/intraday — VWAP whale detector + volume pace scanner\n' +
    '/gappers — live top gappers/gainers\n' +
    '/news — latest catalysts (NLP-verified, ranked 1-5)\n' +
    '/autopsy — 30-day top mover pattern dissection\n' +
    '/backtest — MIS formula validated vs history\n' +
    '/briefing — morning briefing (manual trigger)\n\n' +

    '<b>🤖 WATCHLISTS</b>\n' +
    '/awatch — algo arsenal (7 slots, evolves every 10min)\n' +
