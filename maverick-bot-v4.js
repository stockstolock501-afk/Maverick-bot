...
async function start() {
  console.log('\n╔══════════════════════════════════════╗');
  console.log('║    MAVERICK INTEL BOT v5.8           ║');
  console.log('║    SM% + DURATION + TOP-PICK + CHAIN ║');
  console.log('╚══════════════════════════════════════╝\n');
  ...
  await tg(
    '<b>MAVERICK INTEL BOT v5.8 — ONLINE</b>\n\n' +
    '⚡ Webhook | 📦 Tiered Cache | 🎯 SM% + Duration\n\n' +
    '<b>NEW IN v5.8:</b>\n' +
    '• /top-pick — bot finds the best trade right now, full case\n' +
    '• /check now chains 3 messages: Data → Conviction → Action\n' +
    '• Sequence Match % — how closely you match Seq A or B\n' +
    '• Duration Predictor — 30-min scalp or all-day runner?\n' +
    '• /mis TICKER — alias for /science\n' +
    '• Processing tracker — /status shows what\'s running + elapsed\n' +
    '• ⏳ messages on all heavy commands — no more wondering\n\n' +
  ...
  console.log('[BOT] v5.8 running. SM%+Duration+TopPick live. Chained messages. Processing tracker.');
}
